...
export const SelectIcon: React.FC<IconProps> = (props) => ( // ChevronDown
  <svg viewBox="0 0 16 16" fill="currentColor" {...props}>
...
export const MultiSelectIcon: React.FC<IconProps> = (props) => ( // CheckSquare
  <svg viewBox="0 0 16 16" fill="currentColor" {...props}>
...
export const URLIcon: React.FC<IconProps> = (props) => (
  <svg viewBox="0 0 16 16" fill="currentColor" {...props}>
...
export const FormulaIcon: React.FC<IconProps> = (props) => (
  <svg viewBox="0 0 16 16" fill="currentColor" {...props}>
...
export const RollupIcon: React.FC<IconProps> = (props) => (
  <svg viewBox="0 0 16 16" fill="currentColor" {...props}>
...
export const ButtonIcon: React.FC<IconProps> = (props) => (
  <svg viewBox="0 0 16 16" fill="currentColor" {...props}>
...
export const Aa: React.FC<IconProps> = (props) => (
  <svg viewBox="0 0 16 16" fill="currentColor" {...props}>
